...
public class ExpressionTest {
	public static void main(String[] args) {
		Expression e = new Multiplication(new Addition(new Double(2.5), new Double(3.5)), new UnaryMinus(new Integer(5)));
		
		System.out.println(e.eval()); // should print out -30.0
		System.out.println(e.toString()); // should print out ((2.5 + 3.5) * (-(5)))
		
		Expression e1 = new Multiplication(new Double(6), new Addition(new Integer(4), new Division(new Float(2), new Double(8))));
